...
import kotlinx.android.synthetic.main.activity_forth_stage.*
import kotlinx.android.synthetic.main.activity_forth_stage.layout
import java.util.*
 ...
 * 版权所有，侵权必究
 */
class ForthStageActivity : MyActivity() {
    //这些boolean变量用于控制点击事件
            ...
            when (msg.what) {
                ...
                judgeHeroDeath -> {
                    if (heroVector.dead) {
                        ...
                        val intent = Intent(this@ForthStageActivity, DefeatActivity::class.java)
                ...
                doGhostStrike0 -> {
                    ...
                    heroVector.ghostStrike(
                        enemyVector0.grid, gridView1, this@ForthStageActivity, layout, enemyVector0,
                ...
                doGhostStrike1 -> {
                    ...
                    heroVector.ghostStrike(
                        enemyVector1.grid, gridView1, this@ForthStageActivity, layout, enemyVector1,
                        enemies, (heroVector.attack * 1.5 + 15).toInt()
                    )
                }
                deleteBlood -> {
                ...
                victoryInformation -> {
                    val intent = Intent(this@ForthStageActivity, VictoryActivity::class.java)
                    startActivity(intent)
                }
                jumpEnd -> {
                    enemyVector0.pounce(
                        heroVector.grid, this@ForthStageActivity, layout, gridView1,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_forth_stage)
        //对系统状态栏进行设置，隐藏系统状态栏
        window.setFlags(
        ...
        if (!enemyVector.dead) {
            if (index == 0) {
                enemyVector.clownStrike(
                    heroVector, gridView1, this, layout, heroVector.grid,
                    (enemyVector.attack * 0.25).toInt(), kingShieldOn
                )
                if (kingShieldOn) {
                    kingShieldOn = false
                }
    ...
    override fun onKeyDown(keyCode: Int, event: KeyEvent?): Boolean {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            // 监控返回键
            AlertDialog.Builder(this@ForthStageActivity).setTitle("提示")
                ...
                .setPositiveButton(
                    ...
                    startActivity(intent)
                    this@ForthStageActivity.finish()
                }
